...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  // Navigate to the route or scroll to anchor
  const href = items[index].href;
  
  // If it's the Collection item, just update active state but don't navigate
  if (items[index].label.toLowerCase() === 'collection') {
    // Just update the active state without navigation
    return;
  }
