        ...
        <div className="flex justify-between items-center mb-8">
          ...
          {!isEditing && (
            <div className="flex gap-3">
              <button
                onClick={handleEdit}
                className="flex items-center gap-2 px-4 py-2 bg-[#4fd1c5] hover:bg-[#3db8a8] text-[#1b1b1b] font-semibold rounded-lg transition-colors"
              >
                <Edit2 size={18} />
                Edit
              </button>
            ...
            {!isEditing ? (
              <>
                ...
                <div className="mb-8">
                  ...
                  <h1 className="text-4xl md:text-5xl font-bold text-white leading-relaxed font-chinese">
                    {quote.text}
                  </h1>
                </div>
